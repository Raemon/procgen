import { prefabFromWorldRegion, regionSize, type WorldRegion } from '../prefabs/captureRegionAsPrefab';
import {
  isInsidePrefab,
  MAX_PREFAB_LAYERS,
  MAX_PREFAB_SIDE,
  withCenteredAnchor,
  type Prefab,
} from '../prefabs/prefabDef';
import { paintVoxel } from '../prefabs/prefabPainting';
import { floodFilledIndices } from '../ui/prefabEditor/ops/floodFillLayer';
import { resizedPrefab } from '../prefabs/prefabResize';
import { rotatedPrefab } from '../prefabs/prefabRotation';
import type { PrefabPatch } from '../prefabs/prefabLibrary';
import {
  abilityFailed,
  abilitySucceeded,
  type AbilityContext,
