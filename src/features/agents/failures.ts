...
export const FAILURES: readonly FailureSpec[] = [
  {
    ...
    recovery:
      `The hint names what refused you. The elevation digits in your observation are climb steps: a step up ${CLIMB_STEPS} digits succeeds and needs no jump, higher ground needs another route, and stepping down any drop is free.`,
  },
  {
    code: 'unknown_action',
