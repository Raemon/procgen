...
registerRoute({
  method: 'POST',
  path: '/asset-library/world-seeds/grade',
  summary:
    'grade the running world: a tourist walks it and scores one fun number plus a reading per metric band. Answers with the run to poll under /asset-library/world-seeds/lab',
  body: {
    ...WALK_PARAMS,
...
registerRoute({
  method: 'GET',
  path: '/asset-library/world-seeds/lab',
...
registerRoute({
  method: 'POST',
  path: '/asset-library/world-seeds/lab/{id}/stop',
