...
import { footprintWithYard, massingFor } from '../assembly/buildingMassing';
import { BUILDING_PROGRAMS, massingRulesFor } from '../assembly/buildingPrograms';
import { roofVoxelsOf, type RoofVoxel } from '../assembly/buildingRoof';
import { doorCellOf, shellCellsOf, type ShellCell } from '../assembly/buildingShell';
import { stepOfFacing, type BuildingSpec } from '../assembly/buildingSpec';
import {
  buildingPointOf,
  buildingSeedKeyAt,
  specOfBuildingPoint,
} from '../assembly/buildingPoint';
import { FIRST_WALL_LAYER, FLOOR_LAYER } from '../assembly/buildingTileFallback';
import { NO_PIECES, type PieceSource } from '../assembly/pieceSource';
