...
import { WorldSeedLab } from '../lab/worldSeedLab';
...
export function checkWorldSeedLab(check: CheckReporter): void {
...
function immediateLab(): WorldSeedLab {
  return new WorldSeedLab((task) => task());
}
