...
import { buildPuzzleRoom } from '@/worlds/labyrinth/puzzles/rooms/buildPuzzleRoom';
import type { PuzzleRoomLayout } from '@/worlds/labyrinth/puzzles/rooms/puzzleRoomLayout';
import { forwardSolutionWorks } from '@/worlds/labyrinth/puzzles/kinds/forwardSolutionWorks';
import { canWalkBetween, type CrateFloorSpace } from '@/worlds/labyrinth/puzzles/kinds/crateFloorSpace';
import { cellKey } from '@/worlds/labyrinth/puzzles/kinds/cellKey';
import { RoomCells } from '@/worlds/labyrinth/puzzles/kinds/roomCells';
import { roomIsSolved } from '@/worlds/labyrinth/puzzles/state/fixtureSignals';
