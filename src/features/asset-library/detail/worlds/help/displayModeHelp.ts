import type { DisplayMode } from '@/features/asset-library/worlds/display/displayBinding';
import { displayModesForKind } from '@/features/asset-library/worlds/display/displayBinding';
