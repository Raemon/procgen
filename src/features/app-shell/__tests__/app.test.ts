...
import { checkFreeSearchAndFrontier } from '@/features/asset-library/worlds/__tests__/freeSearchAndFrontier.test';
...
describe('free search and the frontier wing', () => checkFreeSearchAndFrontier(check));
