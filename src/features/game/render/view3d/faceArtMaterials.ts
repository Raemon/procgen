...
import { faceArtPlan, type FaceArtPlan } from '@/features/asset-library/tiles/faceArtFacePlan';
import { facePixelsAt, frameMsOf } from '@/features/asset-library/tiles/faceArtFrames';
import { isTransparentInk, unpaintedInk } from '@/features/asset-library/tiles/inkColor';
import {
  MAX_FACE_ART_SIZE,
  type CubeFace,
  type CubeFaceArt,
