...
import { SIDE_FACES, type FacePixels } from '@/features/asset-library/tiles/tileFaceArt';
...
import { markerAppearance } from '@/features/asset-library/worlds/display/markerAppearance';
