...
const PICK_UP_ACTIONS: readonly { action: string; modes: readonly CommandMode[]; humanControl: string }[] = [
  { action: 'pick_up_item', modes: ['god'], humanControl: 'automatic on walking over it, or G' },
  { action: 'pick_up', modes: ['character', 'topdown'], humanControl: 'automatic on walking over it, or G' },
];
