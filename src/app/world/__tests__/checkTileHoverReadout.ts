...
import { hoveredTileReport, type AgentEyes } from '../world/hover/hoveredTileReport';
import { worldCellOfObservationGridCell } from '../world/render/agentText/observationGridCell';
