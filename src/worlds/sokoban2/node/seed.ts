    ...
    state: {
      ...
      nodes: [
        ...
        },
        {
          ...
          folder: 'the ground',
          comment:
            'Reads the dungeon above and raises ledges and walls two units, bound to elevation at scale 1. A crate is one unit tall, so a ledge is exactly one climb up from the top of a crate and never reachable straight from the floor.',
          enabled: true,
          params: {},
