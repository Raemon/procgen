...
import { fixtureIdIn, type PuzzleRoomLayout } from '../generate/rooms/puzzleRoomLayout';
import { unmetSignals } from '../rules/state/fixtureSignals';
import type { PuzzleState } from '../rules/state/puzzleState';

import type { UseOutcome } from '@/features/game/fixtures/useOutcome';

export type { UseOutcome } from '@/features/game/fixtures/useOutcome';
