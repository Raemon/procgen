...
import { chunkExitsOf, CLOSED, type ChunkExits } from '../generate/layout/chunkExits';
import {
  LABYRINTH_NODE_TYPE,
  LABYRINTH_SEED_LABEL,
  labyrinthKnobsFrom,
  type LabyrinthKnobs,
} from '../node/labyrinthKnobs';
import { LABYRINTH_CELL_SIZE, labyrinthCellOrigin } from '../generate/layout/labyrinthLattice';
