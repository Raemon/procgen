...
import { chunkExitsOf, openExitCount, seamIsOpen } from '../generate/layout/chunkExits';
import { ringOf } from '../generate/layout/chunkRing';
import { roleOf, ROOM } from '../generate/layout/chunkRole';
import { labyrinthKnobsFrom, type LabyrinthKnobs } from '../node/labyrinthKnobs';
import { rectContains, roomGeometryOf, type RoomDoorway, type RoomGeometry } from '../generate/layout/roomLayout';
...
import { forwardSolutionWorks } from '../generate/kinds/forwardSolutionWorks';
import { canWalkBetween, type CrateFloorSpace } from '../generate/kinds/crateFloorSpace';
import { cellKey } from '../generate/kinds/cellKey';
import { RoomCells } from '../generate/kinds/roomCells';
import { roomIsSolved } from '../rules/state/fixtureSignals';
import { PuzzleState } from '../rules/state/puzzleState';
