...
} from '@/features/asset-library/worlds/features/feature';
import {
  registerFeatureExtractor,
  type FeatureExtractionRequest,
} from '@/features/asset-library/worlds/features/featureExtractorRegistry';
import { chunkExitsOf, type ChunkExits } from '../generate/layout/chunkExits';
import { ROOM, roleOf } from '../generate/layout/chunkRole';
import { labyrinthKnobsFrom, type LabyrinthKnobs } from './labyrinthKnobs';
import {
  LABYRINTH_CELL_SIZE,
