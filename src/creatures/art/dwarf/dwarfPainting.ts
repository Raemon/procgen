import { sculptedInk, type SculptLighting, type SurfaceInk } from '../paint/sculptedInk';
import type { SurfaceShade } from '../paint/shapes';
import type { SpriteCanvas } from '../paint/spriteCanvas';
