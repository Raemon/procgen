...
const TILE_CATALOG: readonly TileEntry[] = [
  { name: 'water', symbol: '~', color: '#3a6ea5', walkable: false, role: 'water', art: waterFaceArt },
  ...
  { name: 'tree', symbol: '♠', color: '#2d6a34', walkable: false, role: 'tree', art: treeFaceArt },
  { name: 'rock', symbol: '#', color: '#8b8b85', walkable: false, role: 'rock', art: rockFaceArt },
  { name: 'deep water', symbol: '≈', color: '#1c3c69', walkable: false, role: null, art: deepWaterFaceArt },
  ...
  { name: 'pine tree', symbol: '♣', color: '#234f36', walkable: false, role: 'tree', art: pineTreeFaceArt },
