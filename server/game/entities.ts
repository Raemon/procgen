import type { EntityKind } from '../../src/net/protocol';
import { restingBody, type MovementOrder } from '../../src/sim/movementOrder';
import type { FacingIndex } from '../../src/world/facing';
