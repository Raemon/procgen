    ...
    state: {
      ...
      nodes: [
        ...
        },
        {
          ...
          type: 'thresholdTiles',
          label: 'grassland',
          comment: 'Grass only above 0.52, leaving the coast as sand for the prefabs to sit behind.',
          enabled: true,
        ...
        },
        {
          ...
          label: 'cottages',
          comment:
            'Sparse points on gentle grassland, each stamping the cottage prefab. Random rotation is hashed from the point, so the village varies but never changes between reloads.',
          enabled: true,
