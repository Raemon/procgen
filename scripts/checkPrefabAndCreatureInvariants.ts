...
import { CreatureSim } from '../src/creatures/sim/creatureSim';
import { WANDER } from '../src/creatures/behaviorKinds';
...
import { asPoints } from '../src/procgen/values/valueAccess';
import { EMPTY_TILE } from '../src/procgen/values/chunkValues';
import { WorldSampler } from '../src/procgen/worldSampler';
import { prefabFromWorldRegion } from '../src/prefabs/captureRegionAsPrefab';
import { EMPTY_VOXEL, voxelAt, type Prefab } from '../src/prefabs/prefabDef';
import { PrefabLibrary } from '../src/prefabs/prefabLibrary';
import { resizedPrefab } from '../src/prefabs/prefabResize';
import { rotatedDepth, rotatedPrefab, rotatedWidth } from '../src/prefabs/prefabRotation';
import { asciiSnapshot } from '../src/views/ascii/asciiSnapshot';
import { voxelPlacementsForRect } from '../src/views/view3d/voxelPlacements';
