...
import { facePixelsAt, frameCount } from '../src/world/tiles/faceArtFrames';
import { heightOfInk } from '../src/world/tiles/faceArtHeight';
import { faceGridSize, type CubeFaceArt, type FacePixels } from '../src/world/tiles/tileFaceArt';
