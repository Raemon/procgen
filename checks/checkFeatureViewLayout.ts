import { RANK_NOTABLE, type Feature, type FeatureExtent } from '../procgen/features/feature';
import { clusterFeatures, clusterLabel } from '../world/render/features/featureClusters';
import {
  boxesOverlap,
  layoutLabels,
...
import type { FeaturesCamera } from '../world/render/features/featuresCamera';
import {
  clampedPixelsPerTile,
  FEATURE_SURVEY_SPAN_TILES,
  surveyRectOf,
} from '../world/render/features/featuresSurveyRect';
