...
import { checkPlayerSpawnHasRoomToMove } from './checkPlayerSpawnHasRoomToMove';
...
import { checkStridedEvaluation } from './checkStridedEvaluation';
...
describe('where a player spawns', () => checkPlayerSpawnHasRoomToMove(check));
...
describe('strided evaluation', () => checkStridedEvaluation(check));
